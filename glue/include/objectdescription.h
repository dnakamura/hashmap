...
typedef Object* languageobjectptr_t;  // object reference, used by langauge
typedef Object* omrobjectptr_t;       // object reference, used by OMR internally
typedef Object* omrarrayptr_t;        // array reference, used by OMR internally
